        ...
        <section>
          ...
          <div className='relative pt-12 md:pt-36'>
            <AnimatedGroup
              ...
              className='mask-b-from-35% mask-b-to-90% absolute inset-0 top-24 -z-20 lg:top-16'
            >
              <Image
                src={BackgroundImage}
                alt='background'
            ...
            <div className='mx-auto max-w-7xl px-6'>
              <div className='text-center sm:mx-auto lg:mr-auto lg:mt-0'>
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  >
                    {/* <span className='text-foreground text-primary text-sm'> */}
          ...
          <div className='group relative m-auto max-w-5xl px-6'>
            ...
            <div className='group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14'>
              ...
              <div className='flex'>
                <Image
                  className='mx-auto h-5 object-contain'
                  //   className='mx-auto h-5 object-contain dark:invert-0'
                  src={VercelLogo}
                  alt='Vercel Logo'
                />
              </div>
              ...
              <div className='flex'>
                <Image
                  className='mx-auto h-6 object-contain dark:invert'
                  src={ArcjetLogo}
                  alt='Arcjet Logo'
                />
              </div>
