...
export default function FooterSection() {
  return (
    <footer className='pt-16 pb-8 md:pt-20 md:pb-12'>
      <div className='mx-auto max-w-5xl px-6'>
        ...
        <div className='my-8 flex flex-wrap justify-center gap-6 text-sm'>
          <Link
            href={`https://www.x.com/${TWITTER_ID}`}
            target='_blank'
          ...
          <Link
            href={`https://www.linkedin.com/${LINKEDIN_ID}`}
            target='_blank'
            rel='noopener noreferrer'
            aria-label='LinkedIn'
            className='text-muted-foreground hover:text-primary block'
          ...
          <Link
            href={`https://www.facebook.com/${FBOOK_ID}`}
            target='_blank'
            rel='noopener noreferrer'
            aria-label='Facebook'
            className='text-muted-foreground hover:text-primary block'
          ...
          <Link
            href={`https://www.instagram.com/${INSTA_ID}`}
            target='_blank'
            rel='noopener noreferrer'
